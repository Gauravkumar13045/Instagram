        ...
        <div className=" min-h-screen block md:flex bg-black">
            ...
            <div className="hidden md:flex w-20 hover:w-62.5 flex-col p-4 h-screen fixed space-y-2 pb-6 group transition-all duration-300 overflow-hidden">
                ...
                <div className=" h-full content-center space-y-0 ">
                    ...
                    <div className="flex items-center gap-4 py-2 hover:bg-gray-800 rounded-lg">
                        <div className=" w-10 h-10 p-2 shrink-0  rounded-full cursor-pointer bg-gray-500"><title>Profile</title></div>
                        <Link to="" className="text-white whitespace-nowrap opacity-0 -translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300">Profile</Link>
                    </div>
            ...
            {/* CENTER FEED */}
            <div className="flex-1 max-w-150 mx-auto p-5 xl:ml-62.5 ">
                ...
                <div className="flex w-full gap-4 p-1 pt-2  overflow-x-auto items-center  snap-x snap-mandatory">
                    ...
                    {visibleStories.map((story, i) => (
                        <div key={i} className=" flex flex-col items-center mx-auto snap-start cursor-pointer">
                            ...
                            <span className="text-white text-xs ml-0">{story.username}</span>
                        </div>
                    ))}
            ...
            <div className="hidden xl:block  w-87.5 p-4 ">
                <h1 className="text-red-500">Right Side panel</h1>
            </div>
